...
class DocsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doc" do
    assert_difference('Doc.count') do
      post docs_url, params: { doc: { author: @doc.author, department: @doc.department, type: @doc.type } }
    end
  ...
  test "should update doc" do
    patch doc_url(@doc), params: { doc: { author: @doc.author, department: @doc.department, type: @doc.type } }
